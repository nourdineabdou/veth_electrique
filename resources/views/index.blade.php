...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
                            <div class="header-top-info">
                                <a href="tel:+222-22102020"> Téléphone: <span>+222-22102020</span></a>
                  ...
                  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item"><a class="nav-link" href="#">A PROPOS DE NOUS</a></li>
                       ...
                       <li class="nav-item"><a class="nav-link" href="contact.html">PARTENAIRE </a></li>
                    </ul>
        
                    <form class="form-lg-inline my-2 my-md-0 ml-lg-4 text-center">
                      <a href="#" class="btn btn-solid-border btn-round-full">CONTACT</a>
                    </form>
                  </div>
                </div>
            </nav>
        ...
        <div class="main-wrapper ">
            <!-- Slider Start -->
            <section class="slider" style="background: url('assets/images/installation-electrique-equipement.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 col-md-10">
                            <div class="block">
                                <span class="d-block mb-3 text-white text-capitalize">Préparez-vous à un nouvel avenir</span>
                                <h1 class="animated fadeInUp mb-5"> Notre travail <br> est présentation de notre <br> capacités </h1>
                    ...
                    <div class="row ">
                        <div class="col-lg-8">
                            <div class="section-title">
                                <span class="h6 text-color ">Nous sommes des personnes créatives et expertes</span>
                                <h2 class="mt-3 content-title">Nous travaillons avec les entreprises et fournissons une solution au client avec son problème </h2>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="intro-item mb-5 mb-lg-0"> 
                                ...
                                <h4 class="mt-4 mb-3">Conception moderne et réactive</h4>
                                <p>Il est très important que le client fasse attention au processus d'adipiscissement. Il déteste, nous dirigeons.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="intro-item mb-5 mb-lg-0">
                                <i class="ti-medall color-one"></i> 
                                <h4 class="mt-4 mb-3">Entreprise agréée</h4>
                                <p>Il est très important que le client fasse attention au processus d'adipiscissement. Il déteste, nous dirigeons.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="intro-item">
                                ...
                                <h4 class="mt-4 mb-3">Créez votre site web</h4>
                                <p>Il est très important que le client fasse attention au processus d'adipiscissement. Il déteste, nous dirigeons.</p>
                            </div>
                        </div> 
                    </div>
        ...
        <div class="bg-about" style="background: url('assets/images/team.jpg')"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6 offset-md-0">
                    <div class="about-item ">
                        ...
                        <div class="about-content">
                            <h4 class="mb-3 position-relative">Nous sommes la solution parfaite</h4>
                            <p class="mb-5">Nous fournissons des services de conseil dans le domaine des IFRS et du reporting de gestion, aidant les entreprises à atteindre leur plus haut niveau. Nous optimisons les processus commerciaux en les rendant plus faciles.</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="counter-item text-center mb-5 mb-lg-0">
                            ...
                            <p class="text-muted">Projet terminé</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="counter-item text-center mb-5 mb-lg-0">
                            <h3 class="mb-0"><span class="counter-stat font-weight-bold">125 </span>M </h3>
                            <p class="text-muted">Utilisateur dans le monde entier</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="counter-item text-center mb-5 mb-lg-0">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="counter-item text-center">
                            ...
                            <p class="text-muted">Gagnant du prix </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 ml-auto col-sm-6">
                            <div class="widget">
                                ...
                                <h6><a href="tel:+23-345-67890" >admin@vethelectrique.com</a></h6>
                                <a href="mailto:support@gmail.com"><span class="text-color h4">+222-22102020</span></a>
                            </div>
                        </div>
                    </div>
