      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block text-center">
            ...
            <h1 class="text-capitalize mb-4 text-lg">Entrer en contact</h1>
            <ul class="list-inline">
              <li class="list-inline-item"><a href="{{ route('index') }}" class="text-white">ACCUEILLE</a></li>
              <li class="list-inline-item"><span class="text-white">/</span></li>
              <li class="list-inline-item"><a href="{{ route('contact') }}" class="text-white-50">Contactez-nous</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="row">
              <div class="col-lg-6 col-md-12 col-sm-12">
                   ...
                   <!-- form message -->
                      ...
                      <!-- end message -->
                      <span class="text-color">Envoyer message</span>
                      <h3 class="text-md mb-4">Contacter nous</h3>
